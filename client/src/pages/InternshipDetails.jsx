        ...
        for (let i = 0; i < this.state.data.files.length; i++) {
            for (const key in this.state.data.files[i]) {
                if (this.state.data.files[i].hasOwnProperty(key)) {
                    ...
                    const downloadPDFObjectURL =
                        URL.createObjectURL(downloadPDFBlob);
                    ...
                    <div className="col-md-9 col-lg-10 of">
                        <div className="container-fluid">
                            <h4 className="mt-2">
                                ...
                                <span className="ml-2">
                                    Application: {this.state.data._id}
                                </span>
                            </h4>
                            <hr />
                                ...
                                {this.state.isLoading && <>Loading...</>}
                                {
                                    <>
                                        ...
                                        <div className="card-body">
                                            ...
                                            {this.state.data.approvedBy.length >
                                                0 && (
                                                <>
                                                    Remarks: <br />
                                                    <table className="table tbale-sm">
                                                        <tbody>
                                                            {this.state.data.approvedBy.map(
                                                                (p) => (
                                                                    <tr
                                                                        key={
                                                                            p.designation
